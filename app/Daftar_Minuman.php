...
$query = mysqli_query($conn, "SELECT * FROM tb_daftar_minuman
    LEFT JOIN tb_kategori_menu On tb_kategori_menu.id_kat_menu = tb_daftar_minuman.kategori");
                ...
                <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="../proses/proses_input_minuman.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
            ...
            <div class="modal fade" id="ModalView<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="../proses/proses_edit_minuman.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal fade" id="ModalDelete<?php echo $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-md modal-fullscreen-md-down">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="../proses/proses_delete_minuman.php" method="POST">
                                    <input type="hidden" value="<?php echo $row['id'] ?>" name="id">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div style="width: 80px;"> <img src="../img/<?php echo $row['foto'] ?>" class="img-thumbnail" alt="...">
                                    </td>
                </div>
                </td>
